...
public final class ServerMessageHandler implements IServerMessageHandler {
    ...
    public ServerMessageHandler(ServerMessageHandlerClient client) {
        this(client, null);
    }

    /** Creates a handler. */
    public ServerMessageHandler(ServerMessageHandlerClient client, IDiagnosticFactory diagnosticFactory) {
