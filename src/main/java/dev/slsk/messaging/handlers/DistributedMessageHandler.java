...
public final class DistributedMessageHandler implements IDistributedMessageHandler {
    ...
    public DistributedMessageHandler(DistributedMessageHandlerClient client) {
        this(client, null);
    }

    /** Creates a handler. */
    public DistributedMessageHandler(DistributedMessageHandlerClient client, IDiagnosticFactory diagnosticFactory) {
