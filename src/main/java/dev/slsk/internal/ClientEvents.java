 ...
 * them, generated by hand because the client interface had to declare each one.
 * The interface is gone, and with it the reason. A kind and a {@link Consumer}
 * say the same thing in one method.
 *
...
final class ClientEvents {
    ...
    ClientEvents(BiConsumer<Kind, Throwable> onListenerFault) {
