 ...
 */
public class PrivateMessageReceivedEventArgs extends SoulseekClientEventArgs {
    ...
    /**
     * Creates private-message event arguments.
     *
    ...
    public PrivateMessageReceivedEventArgs(
            int id, Instant timestamp, String username, String message, boolean replayed) {
        this.id = id;
