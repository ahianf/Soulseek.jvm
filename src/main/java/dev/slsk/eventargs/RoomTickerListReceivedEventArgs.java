 ...
 */
public class RoomTickerListReceivedEventArgs extends RoomTickerEventArgs {
    private final List<RoomTicker> tickers;

    /**
     * Creates ticker-list event arguments.
     *
     * @param roomName the room to which the list applies
     * @param tickers the tickers, or {@code null} for an empty list
     */
    public RoomTickerListReceivedEventArgs(String roomName, Iterable<? extends RoomTicker> tickers) {
        super(roomName);
