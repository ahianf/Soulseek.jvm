...
/** Event arguments for the disposition of a search-request response. */
public class SearchRequestResponseEventArgs extends SearchRequestEventArgs {
    private final SearchResponse searchResponse;

    /**
     * Creates response-disposition event arguments.
     *
